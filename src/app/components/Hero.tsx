...
function Hero() {
  return (
    <section
      id='hero'
      className='my-8 flex flex-col items-center gap-8 lg:my-16 lg:flex-row lg:gap-20'
    >
      <header className='flex flex-col items-center gap-6 text-center font-bold uppercase text-white lg:w-[65%] lg:gap-8 lg:text-left'>
        ...
        <div className='flex flex-shrink-0 flex-row gap-8 lg:self-start'>
          <button className='rounded-md bg-purple-400 px-4 py-2 transition-all hover:bg-indigo-300'>
            Hire Me!
          </button>
          ...
          <div className='flex flex-row items-center gap-2'>
            <a
              ...
              className='flex h-9 w-9 items-center justify-center rounded-md bg-gray-800 hover:bg-gray-900'
              target='_blank'
            >
              <BsGithub />
            </a>
      ...
      <div className='hidden self-start lg:flex lg:flex-1'>
        <ul className='flex flex-wrap justify-center gap-2 lg:grid lg:grid-cols-3 lg:self-end'>
          {hobbies.map((hobbie) => (
            <li
              key={hobbie.id}
              className='rounded-md bg-gray-800 px-4 py-2 text-sm font-medium text-white lg:text-center'
            >
              {hobbie.name}
            </li>
          ))}
